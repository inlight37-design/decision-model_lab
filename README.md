...
**[NEXT-SESSION.md](NEXT-SESSION.md)부터 읽습니다.** 환경, 확정된 방침, 열린 결정, 다음 작업이 한 장에 있습니다. **새 컴퓨터에서 처음 연다면 [docs/SETUP.md](docs/SETUP.md)를 먼저 합니다** — 설치 스크립트 둘과 확인 도구 하나로 준비하고, 로그인과 WSL 설치만 직접 합니다. 남은 일·못 고치는 것·조사 거리는 [검토 요청서](docs/reviews/2026-09-25-review-request/README.md)에 모았습니다.
