...
최신 보관본은 [`2026-09-24-before-post-merge-verification.md`](2026-09-24-before-post-merge-verification.md)다. main `eec60e93ef6c95639181eb8cd251506c16290075`의 인계를 병합 재검토·실제 브라우저·K46 관측 뒤 축소하면서 바이트 그대로 보관했다. 사용자 결정과 금지 사항은 현재 인계에도 유지했다. 이 보관본의 K46 미관측·브라우저 미검증 표현은 [후속 기록](../reviews/2026-09-24-post-merge-verification/README.md)이 갱신한다.
