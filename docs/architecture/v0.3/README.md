...
2026-09-22. **v0.3 기반 설계이며 구현 완료 문서가 아니다.** 현재 협업 전략은 [v0.4](../v0.4/README.md)를 따른다. 사용자가 확인한 조건은 **Antigravity(제미나이)·ChatGPT·Claude 사용, 구독 CLI 우선, API 선택, 추후 서비스와 Jev류 부품 확장**이다. 정확한 요금제·설치 버전·남은 한도는 아직 모른다.
