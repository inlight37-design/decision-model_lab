...
> **2026-09-22 판이다 — 지금 상태가 아니다.** 지금 상태와 다음 일은 [NEXT-SESSION.md](../../../NEXT-SESSION.md)에 있다. 이 문서의 "실제 구독 모델을 연결해 실행한 것은 아니다" 같은 문장은 그때의 상태이고, 그 뒤 실제 실행이 관측됐다. 2026-09-25부터 날짜가 박힌 기록으로 다룬다([협업 규칙](../../COLLABORATION.md) 4절).
