...
|---|---|---|
| D10 | 경제성 경로와 상급 협업을 정식 모드로 분리 | F01/F02/F03/F08/F16/F21. 품질 이득이 없는 작업군은 single 유지 |
| D11 | blind first pass, 원 초안 보존, peer 익명화/순서 기록/자기 평가 분리 | F04/F05/F07/F09/F12/F20. 독립성 자체도 검사 대상이며 완전 독립을 가정하지 않음 |
