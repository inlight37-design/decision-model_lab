...
| [근거 원장](sources.json) | F01–F28의 원문·날짜/버전·확인 범위·한계·설계 결정 연결 |
...
F01–F28은 28개의 독립 실험이 아니다. 제품·코드·논문·정책 재확인 기록이며 F17–F19는 기존 E02/E05/E08 재확인이다. F22–F24의 추가 근거와 채택 범위는 [후속 검토](EVIDENCE_FOLLOWUP.md)에, F25–F28은 [외부 검토 기록](REVIEW_FIXES.md)에 있다. 외부 성과를 이 프로젝트의 실측 결과로 사용하지 않는다.
