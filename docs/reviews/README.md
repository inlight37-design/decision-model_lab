...
최신 추가: [`2026-09-25-plugin-surface/`](2026-09-25-plugin-surface/README.md) — 계정 플러그인과 Codex 참여자 표면(모델 없음). 그 앞 [`2026-09-25-merge-56/`](2026-09-25-merge-56/README.md) — #56의 여러 AI 작업 방식 후속 검토를 출처까지 다시 읽고 병합했다. 그 앞 [`2026-09-25-merge-52/`](2026-09-25-merge-52/README.md) — #52의 서버 종료 수정을 사용자 PC(WSL, 모의 참여자)에서 처음 확인했다. 그 앞 [`2026-09-25-strict-live-run/`](2026-09-25-strict-live-run/README.md) — E2 manifest 위에서 앱이 처음으로 독립 정족수를 채웠다. 그 앞 [`2026-09-25-context-independence/`](2026-09-25-context-independence/README.md)는 두 지금 계획의 문맥(C3)을 이 PC·판·30일 범위에서 observed로 기록했다. 앞선 [`Codex 연결 앱 끄기`](2026-09-24-codex-apps-off/README.md)의 "C3 미확인"은 그 당시 계획에 대한 것이다.
