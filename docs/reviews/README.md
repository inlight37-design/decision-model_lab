...
이전 추가: [`2026-09-24-live-pilot-replication/`](2026-09-24-live-pilot-replication/README.md) — 단일 실제 CLI 경로를 다른 세션이 별도 원장으로 재현하고 #34·#35를 병합했다. C3 `failed`와 strict 허가 없음은 그대로다.
