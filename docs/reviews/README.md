...
현재 실행 경로의 후속은 [#46·#47 검토·병합](2026-09-25-merge-46-47/README.md)이다. [#46 기록](2026-09-25-runtime-review/README.md)의 합성 수명주기 수정과 [#47 감사](2026-09-25-runtime-audit-finish/README.md)의 자료 복원 검사를 함께 main에 넣었고, #47이 원격 미반영으로 남긴 사용량 파서(R1)와 새로 찾은 사용량 칸의 NaN(U1)을 고쳤다. 과거 기록의 완료 상태를 현재 head의 CI로 읽지 않는다.
...
최신 추가: [`2026-09-25-merge-46-47/`](2026-09-25-merge-46-47/README.md) — #46·#47을 한 PR로 main에 넣었다. 앞선 [`Codex 연결 앱 끄기`](2026-09-24-codex-apps-off/README.md)의 관측은 보존하며 문맥 독립성(C3)은 아직 미확인이다.
