...
최신 추가: [`2026-09-24-account-limits/`](2026-09-24-account-limits/README.md) — 추가 호출 없이 Claude 계정 한도를 계정 패널에 붙이고, Codex 요청 모델이 가용 목록에 있는지 실제로 확인했다. Claude 화면의 실제 확인은 B의 실행에서 한다.
