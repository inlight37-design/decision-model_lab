...
최신 추가: [`2026-09-24-merge-39/`](2026-09-24-merge-39/README.md) — #39를 정확한 head로 병합하고, 찾은 오류를 고치고, 다음 작업을 무엇을·어떻게·몇 번의 호출로 할지까지 정했다. C3 `failed`와 strict 허가 없음은 그대로다.
