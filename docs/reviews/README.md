...
| [`2026-09-24-structure-audit/`](2026-09-24-structure-audit/README.md) | claude의 구조 전수검사: 덧대기인가 구조적 해결인가. core·app·tools·이력의 판정, 직접 재현한 틈 G1–G9, 적은 코드 순서의 해법. ChatGPT의 같은 주제 검사와 독립으로 썼다(blind). 그 뒤 ChatGPT 검토([PR #20](https://github.com/inlight37-design/decision-model_lab/pull/20))와의 비교는 [`COMPARISON.md`](2026-09-24-structure-audit/COMPARISON.md) |
