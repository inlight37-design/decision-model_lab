...
- D10-D18 map to F01-F21 in [new sources](docs/architecture/v0.4/sources.json); D01-D09 and E01-E31 remain in v0.3. Distinguish primary-source inspection, vendor reports, abstract-only evidence and project proposals.
- Check [validation scope](docs/architecture/v0.4/VALIDATION.md) and the [final review](docs/architecture/v0.4/FINAL_REVIEW.md). Passing offline tests does not establish model quality, citation truth, actual entitlement, sandbox safety or runtime budget enforcement.
