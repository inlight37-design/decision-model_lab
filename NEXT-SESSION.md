...
최종 갱신 **2026-09-25** · 작성 세션: claude(`aux-pc` Windows·WSL `aux-pc-wsl`, 모델 호출 없음) · 브랜치 `claude/merge-52-20260925` · 기준 main `377843b`(PR #52 병합). 앞 판은 ChatGPT 웹 세션이 #52에서 썼고, 그 앞은 claude 세션이 #48–#51에서 썼다.
...
- D의 후속: 합성자를 Codex로 바꾼 같은 비교(Codex 합성 자체는 strict 실행에서 한 번 관측했다 — 비교는 아니다), 제약이 서로 충돌하는 설계 과제, blind 채점([결과](docs/experiments/2026-09-24-comparison-pilot/RESULTS.md)의 한계). 긴 자료(수백 KiB)와 파일 수 상한(20개)은 아직 시험하지 않았다.
